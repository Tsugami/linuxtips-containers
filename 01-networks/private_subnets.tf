...
resource "aws_route_table" "private_internet_1a" {
  vpc_id = aws_vpc.main.id
  tags = {
...
resource "aws_route" "private_access_1a" {
  route_table_id         = aws_route_table.private_internet_1a.id
  destination_cidr_block = "0.0.0.0/0"
  nat_gateway_id         = aws_nat_gateway.nat_1a.id
}


resource "aws_route_table" "private_internet_1b" {
  vpc_id = aws_vpc.main.id
  tags = {
...
resource "aws_route" "private_access_1b" {
  route_table_id         = aws_route_table.private_internet_1b.id
  destination_cidr_block = "0.0.0.0/0"
  nat_gateway_id         = aws_nat_gateway.nat_1b.id
}

resource "aws_route_table" "private_internet_1c" {
  vpc_id = aws_vpc.main.id
  tags = {
...
resource "aws_route" "private_access_1c" {
  route_table_id         = aws_route_table.private_internet_1c.id
  destination_cidr_block = "0.0.0.0/0"
